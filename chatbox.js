class KimiChat extends HTMLElement {
    constructor() {
        ...
        this.messageHistory = [];
        this.historyLength = parseInt(this.getAttribute("history-length")) || 100;
    ...
    initStorageCleanup() {
        window.addEventListener("beforeunload", () => this.cleanStorageIfNeeded());
    ...
    renderMessages() {
        ...
        displayMessages.forEach((msg) => this.renderMessage(msg.content, msg.role));
    }
  ...
  <path d="M8 4v12h12V4H8zM6 2h16v16H6zM4 6v14h14"/>
            ...
            const renderChunk = () => {
                if (index < text.length) {
                    contentDiv.innerHTML = this.parseMarkdown(text.slice(0, ++index));
                    timestamp.textContent = new Date().toLocaleTimeString("zh-CN", {
                        hour: "2-digit",
                        minute: "2-digit",
                    });
